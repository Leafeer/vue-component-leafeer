<template>
  <modular class="all">
    <div>
      ...
      <div class="baise">
        <div class="text"><span>表名：</span> <span>Model</span></div>
        <div class="text">
          <span>数据目录：</span>
          <span>
        ...
        <div class="text">
          <a-row>
            <a-col :span="4"><span>分区信息</span></a-col>
            <a-col :span="16">
              <div class="part">
                <a-row class="text">
                  <a-col :span="8"><span>the_mouth</span></a-col>
                  <a-col :span="16">
                    <span><a-input></a-input></span
                  ></a-col>
                </a-row>
                <a-row class="text">
                  <a-col :span="8"><span>the_date</span></a-col>
                  <a-col :span="16">
                    <span><a-input></a-input></span
                  ></a-col>
                </a-row>
                <a-row class="text">
                  <a-col :span="8"><span>latn</span></a-col>
                  <a-col :span="16">
                    <span><a-input></a-input></span
                  ></a-col>
                </a-row>
        ...
        <div class="text field">
          <a-row class="text">
            <a-col :span="8">
              <a-row>
                <a-col :span="10">
                  <span class="field-text">字段分隔符：</span>
                </a-col>
                <a-col :span="14">
                  <span>
            ...
            <a-col :span="8"
              ...
              <a-row>
                <a-col :span="10">
                  <span class="field-text">换行符：</span>
                </a-col>
                <a-col :span="14">
                  <span>
                    <a-select style="width: 80px">
          ...
          <a-row class="text">
            <a-col :span="8">
              <a-row>
                <a-col :span="10">
                  <span class="field-text">字符集：</span>
                </a-col>
                <a-col :span="14">
                  <span>
                    <a-select style="width: 80px">
            ...
            <a-col :span="8"
              ><a-row>
                <a-col :span="10">
                  <span class="field-text">文件类型</span>
                </a-col>
                <a-col :span="14">
                  <span>
                    <a-select style="width: 80px">
          ...
          <div class="text">
            <span>物理表名：</span>
            <span><a-input class="ipt"></a-input> </span>
            <span>
              <a-select style="width: 80px">
                <a-select-option value="day">天</a-select-option>
                <a-select-option value="mouth">月</a-select-option>
